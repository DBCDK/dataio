...
public class JobSpecification implements Serializable {
     ...
     * @param submitterNumber id of job submitter (> 0)
     ...
     * or if value of submitterNumber is <= 0
     */
    @JsonCreator
    public JobSpecification(@JsonProperty("packaging") String packaging,
        ...
        this.submitterNumber = InvariantUtil.checkLowerBoundOrThrow(submitterNumber, "submitterNumber", Constants.PERSISTENCE_ID_LOWER_BOUND);
    ...
    public boolean equals(Object o) {
        ...
        if (submitterNumber != that.submitterNumber) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) (submitterNumber ^ (submitterNumber >>> 32));
