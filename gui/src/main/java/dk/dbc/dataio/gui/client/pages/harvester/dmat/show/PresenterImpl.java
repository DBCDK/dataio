...
public class PresenterImpl extends AbstractActivity implements Presenter {
    ...
    public void start(AcceptsOneWidget containerWidget, EventBus eventBus) {
        ...
        getView().setHeader(commonInjector.getMenuTexts().menu_DMatHarvester());
    ...
    private void fetchHarvesters() {
        commonInjector.getFlowStoreProxyAsync()
                .findAllDMatHarvesterConfigs(new FetchHarvesterConfigsCallback());
    }
    ...
    class FetchHarvesterConfigsCallback extends FilteredAsyncCallback<List<DMatHarvesterConfig>> {
        ...
        @Override
        public void onSuccess(List<DMatHarvesterConfig> configs) {
