...
public class FlowComponentCreateActivity extends AbstractActivity implements FlowComponentCreateEditPresenter {
    private final FlowComponentCreateEditTexts constants = GWT.create(FlowComponentCreateEditTexts.class);
    ...
    public void projectNameEntered(String projectName) {
        try {
            ...
            flowComponentCreateView.setErrorText(e.getClass().getName() + " - " + e.getMessage() + " - " + Arrays.toString(e.getStackTrace()));
        }
    }
