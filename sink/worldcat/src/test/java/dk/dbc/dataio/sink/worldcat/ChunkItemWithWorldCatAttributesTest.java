...
public class ChunkItemWithWorldCatAttributesTest {
    ...
    @Test
    public void of_multipleAddi_throws() throws IOException {
    ...
    @Test
    public void of_chunkItemWithoutType_throws() {
        ChunkItem chunkItem = successfulChunkItem()
    ...
    public void of_addi() {
        ChunkItem chunkItem = successfulChunkItem()
                .withData(addiRecord.getBytes())
                .withType(ChunkItem.Type.ADDI);
        ChunkItemWithWorldCatAttributes chunkItemWithWorldCatAttributes =
    ...
    public void getActiveHoldingSymbols() {
        WorldCatAttributes attributes = new WorldCatAttributes().withHoldings(Arrays.asList(
    ...
    public void addDiscontinuedHoldings_whenFormerActiveHoldingSymbolsIsNull_holdingsAreLeftUnchanged() {
        Holding originalHolding = new Holding().withSymbol("ABC").withAction(Holding.Action.INSERT);
        WorldCatAttributes attributes = new WorldCatAttributes()
