...
public final class Menu {
    ...
    public Menu() {
        ...
        MenuItem submittersMenu = new MenuItem(GUIID_MAIN_MENU_ITEM_SUBMITTERS, constants.mainMenu_Submitters(), NOWHERE, createSubmitter);
        ...
        MenuItem sinkMenu = new MenuItem(GUIID_MAIN_MENU_ITEM_SINKS, constants.mainMenu_Sinks(), NOWHERE, createSink);

        // Toplevel Main Menu Container
        menuData = new MenuItem("toplevelmainmenu", "Toplevel Main Menu", NOWHERE, submittersMenu, flowsMenu, sinkMenu);
    }
