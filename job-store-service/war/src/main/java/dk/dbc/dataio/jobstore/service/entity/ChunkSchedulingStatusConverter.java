...
public class ChunkSchedulingStatusConverter implements AttributeConverter<ChunkSchedulingStatus, Integer> {
    ...
    public ChunkSchedulingStatus convertToEntityAttribute(Integer chunkProcessStatus) {
        switch ( chunkProcessStatus ) {
            case 1: return ChunkSchedulingStatus.READY_FOR_PROCESSING;
            case 2: return ChunkSchedulingStatus.QUEUED_FOR_PROCESSING;
            case 3: return ChunkSchedulingStatus.BLOCKED;
            case 4: return ChunkSchedulingStatus.READY_FOR_DELIVERY;
            case 5: return ChunkSchedulingStatus.QUEUED_FOR_DELIVERY;
        }
        return null;
    }
}
