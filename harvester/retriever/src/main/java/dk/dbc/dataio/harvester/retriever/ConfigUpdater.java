...
class ConfigUpdater {
     ...
     */
    void push(RetrieverHarvesterConfig config) throws HarvesterException {
        try {
            ...
            if (e instanceof FlowStoreServiceConnectorUnexpectedStatusCodeException
                    ...
                    .getStatusCode() == 409) {
                try {
                    final RetrieverHarvesterConfig refreshedConfig =
                            flowStoreServiceConnector.getHarvesterConfig(
                                    config.getId(), RetrieverHarvesterConfig.class);
