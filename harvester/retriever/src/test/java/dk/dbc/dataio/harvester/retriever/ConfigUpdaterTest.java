...
public class ConfigUpdaterTest {
    ...
    private RetrieverHarvesterConfig config = new RetrieverHarvesterConfig(
            1, 2, new RetrieverHarvesterConfig.Content());
    ...
    public void setupMocks() throws FlowStoreServiceConnectorException {
        ...
        when(flowStoreServiceConnector.getHarvesterConfig(
                anyLong(), eq(RetrieverHarvesterConfig.class)))
                .thenReturn(config);
    }

    @BeforeEach
    public void resetConfig() {
        config = new RetrieverHarvesterConfig(
                1, 2, new RetrieverHarvesterConfig.Content());
    }
    ...
    public void flowStoreReturnsNonOkNonConflict_throws()
        ...
        verify(flowStoreServiceConnector, times(0))
                .getHarvesterConfig(anyLong(), eq(RetrieverHarvesterConfig.class));
    }
