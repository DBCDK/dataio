...
public class HoldingItemsSinkApp extends MessageConsumerApp {
    ...
    private static final SolrDocStoreConnector SOLR_DOC_STORE = new SolrDocStoreConnector(ClientBuilder.newClient(), SinkConfig.SOLR_DOC_STORE_SERVICE_URL.asString());
