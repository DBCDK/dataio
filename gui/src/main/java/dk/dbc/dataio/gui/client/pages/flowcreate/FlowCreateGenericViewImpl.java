 ...
 *
 */
public class FlowCreateGenericViewImpl extends ContentPanel<FlowCreateGenericPresenter> implements FlowCreateGenericView {
     ...
     * Constructor
     */
    public FlowCreateGenericViewImpl() {
