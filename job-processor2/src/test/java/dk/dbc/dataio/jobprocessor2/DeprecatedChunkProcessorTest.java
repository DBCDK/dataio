...
public class DeprecatedChunkProcessorTest {
    ...
    static final String trackingId = "trackin gId_";
    ...
    public static FlowComponentContent getFlowComponentContent(ScriptWrapper scriptWrapper) {
        List<JavaScript> js = List.of(scriptWrapper.javaScript,
                new JavaScript(ResourceReader.getResourceAsBase64(DeprecatedChunkProcessorTest.class, "javascript/jscommon/system/Use.use.js"), "Use"),
                new JavaScript(ResourceReader.getResourceAsBase64(DeprecatedChunkProcessorTest.class, "javascript/jscommon/system/ModulesInfo.use.js"), "ModulesInfo"),
                new JavaScript(ResourceReader.getResourceAsBase64(DeprecatedChunkProcessorTest.class, "javascript/jscommon/system/Use.RequiredModules.use.js"), "Use.RequiredModules"),
                new JavaScript(ResourceReader.getResourceAsBase64(DeprecatedChunkProcessorTest.class, "javascript/jscommon/external/ES5.use.js"), "ES5"),
                new JavaScript(ResourceReader.getResourceAsBase64(DeprecatedChunkProcessorTest.class, "javascript/jscommon/system/Engine.use.js"), "Engine")
        );
