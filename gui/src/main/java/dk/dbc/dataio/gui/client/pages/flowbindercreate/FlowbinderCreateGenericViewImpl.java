 ...
 *
 */
public class FlowbinderCreateGenericViewImpl extends ContentPanel<FlowbinderCreateGenericPresenter> implements FlowbinderCreateGenericView {
     ...
     * Constructor
     */
    public FlowbinderCreateGenericViewImpl() {
