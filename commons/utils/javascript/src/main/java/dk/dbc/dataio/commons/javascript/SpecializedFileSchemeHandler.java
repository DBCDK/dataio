...
public class SpecializedFileSchemeHandler extends FileSchemeHandler {
    ...
    protected void load(File file, Context context, ScriptableObject scope) throws RhinoException, IOException {
        ...
        try {
            ...
            String javascript = readJavascriptFileToUTF8String(file);
            storeJavascript(javascript, filename);
    ...
    private String readJavascriptFileToUTF8String(File file) throws IOException {
        String line = "";
