Egenskab: 150041.credo
    ...
    Scenarie: preparation of xml record from credo
        ...
        Så bliver resultatet addi som i fil 150041.credo.enpost.tickle.txt
    ...
    Scenarie: preparation of another xml record from credo
        ...
        Så bliver resultatet addi som i fil 150041.credo.topost.tickle.txt
    ...
    Scenarie: preparation of xml delete record from credo
        ...
        Så bliver resultatet addi som i fil 150041.credo.delete.tickle.txt
