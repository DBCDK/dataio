...
@Local
@Singleton
public class HarvesterBean extends AbstractHarvesterBean<HarvesterBean, PhHoldingsItemsHarvesterConfig> {
    ...
    @Override
    public int executeFor(PhHoldingsItemsHarvesterConfig config) throws HarvesterException {
