...
public class SinkContent implements Serializable {
    ...
    public SinkContent(String name, String queue, String description, SinkType sinkType, SinkConfig sinkConfig) {
        this(name, queue, description, sinkType, sinkConfig, 1);
    }

    public SinkContent(String name, String queue, String description) {
        this(name, queue, description, NULL_TYPE, NULL_CONFIG, 1);
    }
