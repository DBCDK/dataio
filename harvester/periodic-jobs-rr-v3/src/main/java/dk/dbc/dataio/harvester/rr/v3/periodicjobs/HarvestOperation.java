...
public class HarvestOperation {
    ...
    protected PeriodicJobsV3HarvesterConfig config;
    ...
    public HarvestOperation(PeriodicJobsV3HarvesterConfig config,
    ...
    HarvestOperation(PeriodicJobsV3HarvesterConfig config,
                     BinaryFileStore binaryFileStore,
                     FileStoreServiceConnector fileStoreServiceConnector,
                     FlowStoreServiceConnector flowStoreServiceConnector,
                     JobStoreServiceConnector jobStoreServiceConnector,
    ...
    private RawRepo3Connector createRawRepoConnector(PeriodicJobsV3HarvesterConfig config) {
        return new RawRepo3Connector(config.getContent().getResource(), "dummy");
    }

    RecordSearcher createRecordSearcher() throws HarvesterException {
        String solrZkHost = RawRepo3Connector.RawRepoService.SOLR_ZK.getUrl(rawRepoConnector.getDataSource());
