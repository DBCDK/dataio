...
public class HarvestersTableTest {
    ...
    public void setupRrHarvesterConfigs() {
        rrHarvesterConfigs.add(234L);
        rrHarvesterConfigs.add(233L);
    }
    ...
    public void constructor_data_checkGetValueCallbacks() {
        ...
        assertThat(harvestersTable.getColumn(i++).getValue(testHarvesterConfigEntry1), is("RR2, RR1"));
    ...
    @Test
    public void onDoubleClick_editHoldingsItemConfig_ok() {
        // Test preparation
        harvestersTable = new HarvestersTable(mockedView);
        ...
        verify(mockedPresenter).editHoldingsItemHarvesterConfig("1");
    }
}
