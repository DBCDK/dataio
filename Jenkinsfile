...
pipeline {
    ...
    environment {
        MAVEN_OPTS="-Dmaven.repo.local='/home/isworker/.m2/dataio-repo/dk/dbc' -XX:+TieredCompilation -XX:TieredStopAtLevel=1 -Dorg.slf4j.simpleLogger.showThreadName=true -Dorg.slf4j.simpleLogger.log.org.apache.maven.cli.transfer.Slf4jMavenTransferListener=warn"
