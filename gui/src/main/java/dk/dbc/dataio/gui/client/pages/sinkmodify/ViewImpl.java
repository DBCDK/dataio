...
public class ViewImpl extends ContentPanel<Presenter> implements View {
     ...
     * Constructor
     */
    public ViewImpl(String header, SinkModifyConstants constants) {
        super(header);
        namePanel = new TextEntry(GUIID_SINK_MODIFY_SINK_NAME_PANEL, constants.label_SinkName());
        resourcePanel = new TextEntry(GUIID_SINK_MODIFY_RESOURCE_NAME_PANEL, constants.label_ResourceName());
