...
public class MetaDataTest {
    ...
    public void getInfoJson_nodeIsMissing_returnsEmptyJson() throws IOException {
        String metadataString = String.format(AddiContextTest.ES_REFERENCE_DATA_XML_TEMPLATE,
                "",
                AddiContextTest.SINK_DIRECTIVES,
                AddiContextTest.UPDATE_SINK_DIRECTIVES);
        MetaData metaData = MetaData.fromXml(metadataString.getBytes(StandardCharsets.UTF_8));
