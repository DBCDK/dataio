...
/**
 * Orchestrates the harvesting of articles from the retriever platform.
 * <p>
...
public class HarvestOperation {
    ...
    static List<LocalDate> getPublicationDatesToHarvest(RetrieverHarvesterConfig config) {
    ...
    private final RetrieverHarvesterConfig config;
    ...
    public HarvestOperation(RetrieverHarvesterConfig config,
