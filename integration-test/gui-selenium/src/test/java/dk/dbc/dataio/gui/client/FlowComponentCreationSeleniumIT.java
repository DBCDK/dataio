...
public class FlowComponentCreationSeleniumIT extends AbstractGuiSeleniumTest {
    ...
    public void testFlowComponentCreationValidSvnProjectNamePopulatesListBoxes() {
        ...
        waitForListBoxToFillOut(FlowComponentCreateEditViewImpl.GUIID_FLOW_COMPONENT_CREATION_EDIT_INVOCATION_METHOD_PANEL, DataEntry.DATA_ENTRY_INPUT_BOX_CLASS, SVN_TIMEOUT);
    ...
    public void testFlowComponentCreationSuccessfulSave_saveResultLabelContainsSuccessMessage() throws Exception {
        ...
        SeleniumUtil.waitAndAssert(webDriver, 10, FlowComponentCreateEditViewImpl.GUIID_FLOW_COMPONENT_CREATION_EDIT_SAVE_BUTTON_PANEL, SaveButton.SAVE_BUTTON_RESULT_LABEL_CLASS, texts.translate("status_FlowComponentSuccessfullySaved"));
    }
    ...
    private static WebElement findFlowComponentCreationWidget(WebDriver webDriver) {
        return SeleniumUtil.findElementInCurrentView(webDriver, FlowComponentCreateEditViewImpl.GUIID_FLOW_COMPONENT_CREATION_EDIT_WIDGET);
    }
