...
@Singleton
public class HarvesterConfigurationBean extends AbstractHarvesterConfigurationBean<PhHoldingsItemsHarvesterConfig> {
    ...
    @Override
    public Class<PhHoldingsItemsHarvesterConfig> getConfigClass() {
        return PhHoldingsItemsHarvesterConfig.class;
    }
}
