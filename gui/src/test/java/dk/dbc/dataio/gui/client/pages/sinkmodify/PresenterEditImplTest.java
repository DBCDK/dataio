...
public class PresenterEditImplTest {
    ...
    class PresenterEditImplConcrete extends PresenterEditImpl {
        public PresenterEditImplConcrete(Place place, ClientFactory clientFactory, SinkModifyConstants constants) {
    ...
    public void constructor_instantiate_objectCorrectInitialized() {
        ...
        // Since we cannot access the protected view attribute in presenterEditImpl, we can only test, that no exceptions are thrown
    ...
    public void getSinkModelFilteredAsyncCallback_unsuccessfulCallback_setErrorTextCalledInView() {
        ...
        presenterEditImplConcrete.getSinkCallback.onFailure(new Throwable(mockedConstants.error_CannotFetchSink()));
        // Expect the error text to be set in View
        verify(mockedEditView, times(1)).setErrorText(mockedConstants.error_CannotFetchSink());
    }
