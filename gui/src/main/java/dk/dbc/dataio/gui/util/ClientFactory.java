...
public interface ClientFactory {
    ...
    dk.dbc.dataio.gui.client.pages.flowcomponent.show.FlowComponentsShowView getFlowComponentsShowView();
    dk.dbc.dataio.gui.client.pages.flow.oldshow.FlowsShowView getFlowsShowView();
