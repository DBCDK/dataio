...
@Singleton
@Startup
public class ScheduledHarvestBean extends AbstractScheduledHarvestBean<HarvesterBean, DMatDM3HarvesterConfig, HarvesterConfigurationBean> {
    ...
    @Override
    public boolean canRun(DMatDM3HarvesterConfig config) {
        try {
