...
public class DMatSinkApp extends MessageConsumerApp {
    ...
    private static final DMatServiceConnector DMAT_SERVICE_CONNECTOR = new DMatServiceConnector(ClientBuilder.newClient().register(new JacksonFeature()), SinkConfig.DMAT_SERVICE_URL.asString());
