...
public class FbsUpdateConnectorException extends Exception {
    private static final long serialVersionUID = -1255881793710499182L;
     ...
     */
    public FbsUpdateConnectorException(String message) {
        super(message);
    }
     ...
     *               unknown).
     */
    public FbsUpdateConnectorException(String message, Exception cause) {
        super(message, cause);
    }
}
