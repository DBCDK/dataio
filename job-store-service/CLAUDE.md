...
| `CHUNK_RESEND_LIMIT` | How many times one stale chunk whose work is still outstanding may be sent again before `AdminBean` reports it as beyond repair (default `3`) |
