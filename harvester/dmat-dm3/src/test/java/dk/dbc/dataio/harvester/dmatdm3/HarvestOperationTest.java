...
class HarvestOperationTest {
    ...
    void setupMocks() throws Exception {
        ...
        final DMatDM3HarvesterConfig config = newConfig();
    ...
    void noCasesToHarvest() throws HarvesterException, DMatServiceConnectorException, JobStoreServiceConnectorException,
        ...
        verify(flowStoreServiceConnector).updateHarvesterConfig(any(DMatDM3HarvesterConfig.class));
    }
    ...
    void harvestOneRecord() throws HarvesterException, DMatServiceConnectorException, JobStoreServiceConnectorException,
        ...
        when(recordServiceConnector.getRecordDataCollection(191919, MATCH_FAUST, fetchParameters()))
    ...
    @Test
    void harvestWithMissingRrRecordThrows() throws DMatServiceConnectorException, RecordServiceConnectorException, JSONBException, JobStoreServiceConnectorException, HarvesterException {
        LocalDateTime accession = LocalDateTime.now();
    ...
    void harvestNewCreateRecord() throws HarvesterException, DMatServiceConnectorException, JobStoreServiceConnectorException,
        ...
        verify(dmatServiceConnector).updateRecordStatus(1, Status.PROCESSING);
        verify(dmatServiceConnector).updateRecordStatus(1, Status.EXPORTED);
        verify(recordServiceConnector, times(0)).getRecordDataCollection(anyInt(), anyString(), any());
        verify(jobStoreServiceConnector).addJob(any(JobInputStream.class));
        verify(flowStoreServiceConnector).updateHarvesterConfig(any(DMatDM3HarvesterConfig.class));
    }
    ...
    void harvestNewCloneRecord() throws HarvesterException, DMatServiceConnectorException, JobStoreServiceConnectorException,
        ...
        verify(dmatServiceConnector).updateRecordStatus(1, Status.PROCESSING);
        verify(dmatServiceConnector).updateRecordStatus(1, Status.EXPORTED);
        verify(recordServiceConnector, times(1)).getRecordDataCollection(191919, MATCH_FAUST, fetchParameters());
        verify(jobStoreServiceConnector).addJob(any(JobInputStream.class));
        verify(flowStoreServiceConnector).updateHarvesterConfig(any(DMatDM3HarvesterConfig.class));
    }
    ...
    void harvestReviewRecord() throws HarvesterException, DMatServiceConnectorException, JobStoreServiceConnectorException,
        ...
        when(recordServiceConnector.getRecordDataCollection(191919, REVIEW_FAUST, fetchParameters()))
                .thenReturn(Collections.emptyList());
        ...
        verify(dmatServiceConnector).updateRecordStatus(1, Status.PROCESSING);
        verify(dmatServiceConnector).updateRecordStatus(1, Status.EXPORTED);
        verify(recordServiceConnector, times(1)).getRecordDataCollection(191919, REVIEW_FAUST, fetchParameters());
        verify(jobStoreServiceConnector).addJob(any(JobInputStream.class));
        verify(flowStoreServiceConnector).updateHarvesterConfig(any(DMatDM3HarvesterConfig.class));
    }
    ...
    void harvestUpdateRecord() throws HarvesterException, DMatServiceConnectorException, JobStoreServiceConnectorException,
        ...
        when(recordServiceConnector.getRecordDataCollection(191919, RECORD_FAUST, fetchParameters()))
                .thenReturn(Collections.emptyList());
        ...
        verify(dmatServiceConnector).updateRecordStatus(1, Status.PROCESSING);
        verify(dmatServiceConnector).updateRecordStatus(1, Status.EXPORTED);
        verify(recordServiceConnector, times(1)).getRecordDataCollection(191919, RECORD_FAUST, fetchParameters());
        verify(jobStoreServiceConnector).addJob(any(JobInputStream.class));
        verify(flowStoreServiceConnector).updateHarvesterConfig(any(DMatDM3HarvesterConfig.class));
    }

    @Test
    void harvestInvalidRecords() throws DMatServiceConnectorException, JSONBException, JobStoreServiceConnectorException, HarvesterException {
    ...
    @Test
    void harvestOneFailingRecord() throws HarvesterException, DMatServiceConnectorException, JobStoreServiceConnectorException,
            FlowStoreServiceConnectorException, JSONBException, RecordServiceConnectorException {
        LocalDateTime accession = LocalDateTime.now();
        ...
        verify(recordServiceConnector, times(1)).getRecordDataCollection(anyInt(), anyString(), any());
        verify(recordServiceConnector, times(1)).getRecordDataCollection(191919, RECORD_FAUST, fetchParameters());
    ...
    void harvestFailingUpdateRecord() throws HarvesterException, DMatServiceConnectorException, JobStoreServiceConnectorException,
        ...
        when(recordServiceConnector.getRecordDataCollection(191919, RECORD_FAUST, fetchParameters()))
                .thenReturn(Collections.emptyList());
        when(recordServiceConnector.getRecordDataCollection(191919, "98765432", fetchParameters()))
                .thenThrow(new RecordServiceConnectorException("No content"));
        ...
        verify(recordServiceConnector, times(3)).getRecordDataCollection(anyInt(), anyString(), any());
        verify(recordServiceConnector, times(2)).getRecordDataCollection(191919, RECORD_FAUST, fetchParameters());
        verify(recordServiceConnector, times(1)).getRecordDataCollection(191919, "98765432", fetchParameters());
    ...
    @Test
    void harvestAllRecordsWithOneFailingOnStatusProcessing() throws HarvesterException, DMatServiceConnectorException, JobStoreServiceConnectorException,
            FlowStoreServiceConnectorException, JSONBException, RecordServiceConnectorException {
        LocalDateTime accession = LocalDateTime.now();
    ...
    @Test
    void harvestAllRecordsWithOneFailingOnStatusExported() throws HarvesterException, DMatServiceConnectorException, JobStoreServiceConnectorException,
            FlowStoreServiceConnectorException, JSONBException, RecordServiceConnectorException {
        LocalDateTime accession = LocalDateTime.now();
    ...
    private HarvestOperation newHarvestOperation(DMatDM3HarvesterConfig config) throws HarvesterException {
        HarvestOperation.dmatServiceFetchSize = 2;     // force multiple iterations when dealing with >2 cases
    ...
    private DMatDM3HarvesterConfig newConfig() {
        final DMatDM3HarvesterConfig config = new DMatDM3HarvesterConfig(
                1, 2, new DMatDM3HarvesterConfig.Content());
        config.getContent()
    ...
    private static final String MATCH_FAUST = "1213456789";
    private static final String REVIEW_FAUST = "456789123";
    private static final String RECORD_FAUST = "789123456";
    private static final String PROMAT_FAUST = "147258369";
