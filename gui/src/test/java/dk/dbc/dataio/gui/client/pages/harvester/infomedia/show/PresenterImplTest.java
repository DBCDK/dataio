...
public class PresenterImplTest extends PresenterImplTestBase {
    ...
    public void createPresenterImpl() {
        presenterImpl = new TestablePresenterImpl();
    }

    private TestablePresenterImpl presenterImpl;
    ...
    public void start() {
        ...
        verify(mockedFlowStore).findAllInfomediaHarvesterConfigs(any(AsyncCallback.class));
    ...
    public void onSuccessWhenFetchingHarvesterConfigs() {
        final List<InfomediaHarvesterConfig> configs = new ArrayList<>();
        presenterImpl.start(mockedContainerWidget, mockedEventBus);
