 ...
 * to the rr-harvester REST interface.
 */
...
public class RRHarvesterServiceConnectorBean {
    ...
    public RRHarvesterServiceConnector getConnector() {
        return rrHarvesterServiceConnector;
    }

    @PreDestroy
    public void tearDownConnector() {
        HttpClient.closeClient(rrHarvesterServiceConnector.getHttpClient());
    }
}
