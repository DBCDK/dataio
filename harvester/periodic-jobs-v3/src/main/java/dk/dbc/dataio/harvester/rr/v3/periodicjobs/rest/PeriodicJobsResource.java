...
import dk.dbc.dataio.harvester.rr.v3.periodicjobs.HarvesterBean;
import dk.dbc.dataio.harvester.rr.v3.periodicjobs.HarvesterConfigurationBean;
...
public class PeriodicJobsResource {
    ...
    public Response createPeriodicJob(Long id) throws HarvesterException {
        Optional<PeriodicJobsV3HarvesterConfig> config = harvesterConfigurationBean.getConfig(id);
        if (!config.isPresent()) {
