...
public class HoldingsItemHarvesterConfig extends HarvesterConfig<HoldingsItemHarvesterConfig.Content> implements  Serializable {
    private static final long serialVersionUID = -334384758458870872L;

    @JsonCreator
    public HoldingsItemHarvesterConfig(
