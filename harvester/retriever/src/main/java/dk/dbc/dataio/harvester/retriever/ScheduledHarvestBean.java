...
@Singleton
@Startup
public class ScheduledHarvestBean extends AbstractScheduledHarvestBean<HarvesterBean, RetrieverHarvesterConfig, HarvesterConfigurationBean> {
    ...
    @Override
    public boolean canRun(RetrieverHarvesterConfig config) {
        try {
