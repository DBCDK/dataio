...
@Singleton
public class HarvesterBean extends AbstractHarvesterBean<HarvesterBean, RetrieverHarvesterConfig> {
    ...
    @Override
    public int executeFor(RetrieverHarvesterConfig config) throws HarvesterException {
        try {
