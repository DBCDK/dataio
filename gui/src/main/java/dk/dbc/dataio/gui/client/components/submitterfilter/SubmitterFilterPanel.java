...
import dk.dbc.dataio.gui.client.events.HasSubmitterFilterPanelHandlers;
import dk.dbc.dataio.gui.client.events.SubmitterFilterPanelEvent;
import dk.dbc.dataio.gui.client.events.SubmitterFilterPanelHandler;
 ...
 * ...
 * <dio:SubmitterFilterPanel title="Panel Title">
...
public class SubmitterFilterPanel extends Composite implements HasWidgets, HasSubmitterFilterPanelHandlers {
     ...
     */
    @UiConstructor
    SubmitterFilterPanel(String title, Resources resources, boolean invertFilter) {
    ...
    void invertButtonClicked(ClickEvent event) {
        if (invertFilter) {
            invertFilter = false;
            triggerFilterPanelEvent(SubmitterFilterPanelEvent.FilterPanelButton.MINUS_BUTTON);
        } else {
            invertFilter = true;
            triggerFilterPanelEvent(SubmitterFilterPanelEvent.FilterPanelButton.PLUS_BUTTON);
        }
    ...
    void deleteButtonClicked(ClickEvent event) {
        triggerFilterPanelEvent(SubmitterFilterPanelEvent.FilterPanelButton.REMOVE_BUTTON);
    }
     ...
     */
    @Override
    public HandlerRegistration addSubmitterFilterPanelHandler(SubmitterFilterPanelHandler handler) {
        submitterFilterPanelHandler = handler;
        return () -> submitterFilterPanelHandler = null;
    }
    ...
    protected void triggerFilterPanelEvent(SubmitterFilterPanelEvent.FilterPanelButton button) {
        if (submitterFilterPanelHandler != null) {
            submitterFilterPanelHandler.onSubmitterFilterPanelButtonClick(new SubmitterFilterPanelEvent() {
                @Override
