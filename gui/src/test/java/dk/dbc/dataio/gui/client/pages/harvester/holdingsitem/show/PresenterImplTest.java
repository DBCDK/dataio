...
public class PresenterImplTest extends PresenterImplTestBase {
    ...
    class PresenterImplConcrete extends PresenterImpl {
        ...
        GetHoldingsItemHarvestersCallback getHarvestersCallback = new GetHoldingsItemHarvestersCallback();
    }
    ...
    public void start_callStart_ok() {
        ...
        verify(mockedFlowStore).findAllHoldingsItemHarvesterConfigs(any(AsyncCallback.class));
