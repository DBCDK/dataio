...
public class AddiDiffGeneratorTest extends AbstractDiffGeneratorTest {
    ...
    public void plaintextDiff() throws DiffGeneratorException, InvalidMessageException {
        if (canDiff()) {
            byte[] currentAddiBytes = "9\nmetadata1\n8\ncontent1\n9\nmetadata2\n8\ncontent2\n".getBytes(StandardCharsets.UTF_8);
            byte[] nextAddiBytes = "9\nmetadataA\n8\ncontentA\n9\nmetadata2\n8\ncontent2\n".getBytes(StandardCharsets.UTF_8);
            String diff = addiDiffGenerator.getDiff(currentAddiBytes, nextAddiBytes);
    ...
    public void jsonDiff() throws DiffGeneratorException, InvalidMessageException {
        if (canJsonDiff()) {
            byte[] currentAddiBytes = "14\n{\"metadata\":1}\n13\n{\"content\":1}\n14\n{\"metadata\":2}\n13\n{\"content\":2}\n".getBytes(StandardCharsets.UTF_8);
            byte[] nextAddiBytes = "14\n{\"metadata\":1}\n13\n{\"content\":1}\n16\n{\"metadata\":\"B\"}\n15\n{\"content\":\"B\"}\n".getBytes(StandardCharsets.UTF_8);
            String diff = addiDiffGenerator.getDiff(currentAddiBytes, nextAddiBytes);
    ...
    public void xmlDiff() throws DiffGeneratorException, InvalidMessageException {
        if (canXmlDiff()) {
            byte[] currentAddiBytes = "22\n<metadata>1</metadata>\n20\n<content>1</content>\n22\n<metadata>2</metadata>\n20\n<content>2</content>\n".getBytes(StandardCharsets.UTF_8);
            byte[] nextAddiBytes = "22\n<metadata>1</metadata>\n20\n<content>1</content>\n22\n<metadata>B</metadata>\n20\n<content>B</content>\n".getBytes(StandardCharsets.UTF_8);
            String diff = addiDiffGenerator.getDiff(currentAddiBytes, nextAddiBytes);
