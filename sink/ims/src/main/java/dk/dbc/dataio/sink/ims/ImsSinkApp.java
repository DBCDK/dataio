...
public class ImsSinkApp extends MessageConsumerApp {
    ...
    private static final ImsConfig imsConfig = new ImsConfig(new FlowStoreServiceConnector(
            ClientBuilder.newClient().register(new JacksonFeature()), UserAgent.forInternalRequests(), FLOWSTORE_URL.asString()));
