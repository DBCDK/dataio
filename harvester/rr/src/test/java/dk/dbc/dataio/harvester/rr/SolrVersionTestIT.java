...
public class SolrVersionTestIT {
    ...
    public void testVersion() throws SolrServerException, IOException {
        testServer(new HttpSolrClient.Builder("http://fbstest.solr.dbc.dk:8983/solr/fbstest-ims-searcher").build());
        testServer(new HttpSolrClient.Builder("http://cisterne.solr.dbc.dk:8983/solr/cisterne-ims-searcher").build());
