...
@Singleton
public class HarvesterBean extends AbstractHarvesterBean<HarvesterBean, DMatDM3HarvesterConfig> {
    ...
    public int executeFor(DMatDM3HarvesterConfig config) throws HarvesterException {
        try {
            ...
            metricsHandler.counter(DmatDm3HarvesterMetrics.UNHANDLED_EXCEPTIONS.getMetadata()).inc();
            throw e;
        } catch(Exception e) {
