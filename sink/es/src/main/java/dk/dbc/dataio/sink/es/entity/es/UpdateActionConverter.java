...
public class UpdateActionConverter implements AttributeConverter<UpdateAction, Integer > {
    ...
    public Integer convertToDatabaseColumn(UpdateAction updateAction) {
        switch ( updateAction ) {
            ...
            case ELEMENT_UPDATE: return 4;
            case SPECIAL_UPDATE: return 5;
        }
        return null;
    }
    ...
    public UpdateAction convertToEntityAttribute(Integer integer) {
        switch( integer ) {
            case 1: return UpdateAction.INSERT;
            case 2: return UpdateAction.REPLACE;
            case 3: return UpdateAction.DELETE;
            case 4: return UpdateAction.ELEMENT_UPDATE;
            case 5: return UpdateAction.SPECIAL_UPDATE;
            default:
